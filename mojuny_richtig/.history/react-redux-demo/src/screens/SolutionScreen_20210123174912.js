...
export function SolutionScreen(props) {
  ...
  // if ask (subcategory:decisionstate 1)
  //   load CollectionAsk("mainCategory/strategy/subCategory/ask/1")
  // if code (subcategory:decisionstate 2)
  //   load collection code ("mainCategory/strategy/subCategory/code/codeSolutions")
  ...
  return (
    <div className="screen">
      <label>Wähle eine Option aus: </label>
      <br></br>
      <br></br>
